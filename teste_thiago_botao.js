...
var config = {
	...
	prefix: '/qap/',
	port: 443,
	isSecure: false //windows.location.protocol === "https:"
};
...
require( ["js/qlik"], function ( qlik ) {
	...
	var app = qlik.openApp('27305ef0-e560-4638-8c81-3d90592033d5', config);


	//get objects -- inserted here --
	app.getObject('QV02','YtPWQCK');
	app.getObject('QV01','KFFtHPr');
	app.getObject('QV04','GPZCjk');
